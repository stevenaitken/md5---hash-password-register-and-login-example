...
<head>
    ...
    <title>Hash Passwords  -login</title>
...
<header><h1>Hash Passwords md5()- login and verify user and password</h1>
...
<input type="text" name="pwd" id="pwd" class="form-input" required title="Enter password" placeholder="Enter password">
